...
In the context of limiting access to sensor data that can reveal private information,
...
to deny access specified in its manifest file.  This is the first level of defense.
A second level of defense would be to restrict access to sensor data in a
...
Unlike the existing privacy controls, BlurSense
