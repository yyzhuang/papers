...
The smartphone consumes only 31.5mA/sec with no apps running, and 56.5 mA/sec with the radio app
running.
But when playing a video ad, the consumption is 169.5mA/sec. 
