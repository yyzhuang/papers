\section{TRUST EVALUATION METRICS BASED ON TECHNOLOGICAL (internal sensors) PARAMETERS}
...
they can also be influenced by extraneous factors unrelated to security and trustworthiness.
