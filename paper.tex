...
\begin{abstract}
Evaluating trust for complex and diverse systems is a signficant challenge.
In order to manage the complexity, we use 
a hierarchical evaluation methodology that combines trust metrics from characteristics of individual components
with trust metrics that are based on the consistency of sensor data from multiple components.
